...
window.addEventListener("load", function() {
      ...
      for (let i = 0; i < orderForm.elements.length; i++) {
            orderForm.elements[i].addEventListener("change", clacOrder);
      }
      ...
      function calcOrder() {
            ...
            //Calaculate the total cost of the order 
            ...
            orderForm.elements.planName.value = sleectedPlan.labels[0].textContent;
      }
});
